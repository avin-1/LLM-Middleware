...
class SentinelAnalyzer:
    ...
    def __init__(self):
        ...
        self._qwen_enabled = os.getenv("QWEN_GUARD_ENABLED", "false").lower() == "true"  # Changed default to false
    ...
    async def analyze(self, prompt: str, context: dict) -> dict:
        ...
        from .shapeshifter import get_session_config
        ...
        from .semantic_tide import get_semantic_tide
        ...
        from .cognitive_mirror import get_cognitive_mirror
